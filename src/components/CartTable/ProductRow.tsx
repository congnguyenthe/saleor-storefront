...
import { ProductVariant } from "@saleor/sdk/fragments/gqlTypes/ProductVariant";
import { OrderByToken_orderByToken_lines_unitPrice } from "@saleor/sdk/queries/gqlTypes/OrderByToken";
